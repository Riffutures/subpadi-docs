  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'Discord',
                href: 'https://discordapp.com/invite/subpadi',
              },
              {
                label: 'Twitter',
                href: 'https://twitter.com/subpadi',
              },
            ],
          },
          {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Subpadi, LTD. Built with Docusaurus.`,
      },
      prism: {
